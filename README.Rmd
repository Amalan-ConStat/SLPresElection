...
[![GitHub license](https://img.shields.io/github/license/Amalan-ConStat/SLPresElection.svg?style=popout)](https://github.com/Amalan-ConStat/SLPresElection/blob/master/LICENSE)
...
[![Travis build status](https://travis-ci.org/Amalan-ConStat/SLPresElection.svg?branch=master)](https://travis-ci.org/Amalan-ConStat/SLPresElection)
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/Amalan-ConStat/SLPresElection?branch=master&svg=true)](https://ci.appveyor.com/project/Amalan-ConStat/SLPresElection)
[![Codecov test coverage](https://codecov.io/gh/Amalan-ConStat/SLPresElection/branch/master/graph/badge.svg)](https://codecov.io/gh/Amalan-ConStat/SLPresElection?branch=master)
...
```{r Registered and Polled Votes,fig.width=12,fig.height=8,quietly = TRUE}
Election1982 %>% 
...
```{r Registered and Polled Votes over the years,fig.width=12,fig.height=8,quietly = TRUE}
Final_Data %>%
  subset(ColNames=="No of Registered Electors" & Electorate=="Final District Results" | 
           ColNames=="Total No of Votes Polled" & Electorate=="Final District Results") %>%
...
```{r Rejected Votes over the years,fig.width=8,fig.height=6,quietly = TRUE}
Final_Data %>%
